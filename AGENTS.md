...
This project is indexed by GitNexus as **raven** (2456 symbols, 5157 relationships, 130 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
