...
This project is indexed by GitNexus as **raven** (1441 symbols, 2405 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
