...
This project is indexed by GitNexus as **raven** (2478 symbols, 4634 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
