...
This project is indexed by GitNexus as **raven** (2172 symbols, 3950 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
