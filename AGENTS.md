...
This project is indexed by GitNexus as **raven** (1706 symbols, 2943 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
