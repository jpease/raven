...
This project is indexed by GitNexus as **raven** (876 symbols, 1378 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
