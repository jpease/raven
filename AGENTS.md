...
This project is indexed by GitNexus as **raven** (2165 symbols, 3939 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
