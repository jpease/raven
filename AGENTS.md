...
This project is indexed by GitNexus as **raven** (1690 symbols, 2905 relationships, 83 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
