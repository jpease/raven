...
This project is indexed by GitNexus as **raven** (2541 symbols, 4750 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
