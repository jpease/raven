...
This project is indexed by GitNexus as **raven** (706 symbols, 1047 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
