...
This project is indexed by GitNexus as **raven** (2290 symbols, 4200 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
